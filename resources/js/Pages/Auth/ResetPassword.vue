...
<template>
    ...
    <AuthenticationCard>
        ...
        <div class="mb-8 text-center">
            <h2 class="text-3xl font-bold text-white mb-2">Сброс пароля</h2>
            <p class="text-gray-400">Введите новый пароль для вашего аккаунта</p>
        </div>
        ...
        <form @submit.prevent="submit" class="space-y-6">
            ...
            <div>
                <InputLabel for="password" value="Новый пароль" class="text-gray-300" />
                <TextInput
                    id="password"
            ...
            <div>
                <InputLabel for="password_confirmation" value="Подтвердите пароль" class="text-gray-300" />
                <TextInput
